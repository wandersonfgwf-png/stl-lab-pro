...
const Pricing: React.FC = () => {
  ...
  const essentialLink = "https://pay.cakto.com.br/rttmvb7";
  const proLink = "https://pay.cakto.com.br/5jfjtun_781727";
  const upgradeSpecialLink = "https://pay.cakto.com.br/77oo2gc";
